...
export const emailTemplates = {
  ...
  generateTeamInviteHTML: (data: EmailTemplateData): string => {
    const { teamName, inviterName, inviteeEmail, inviteCode, appUrl } = data;
    ...
    return `
      ...
      <body>
        ...
        <div class="content">
          ...
          <ol>
            <li>Visit our app at <a href="${appUrl}">${appUrl}</a></li>
            <li>Click on "Join Team" in the Team Space section</li>
          ...
          <div style="text-align: center;">
            <a href="${appUrl}" class="button">Join Team Now</a>
          </div>
