...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 h-full shadow-lg border-r border-gray-200 dark:border-slate-800 flex flex-col transition-colors duration-300">
      {/* Mobile Header */}
      {isMobile && (
        <div className="p-3 sm:p-4 border-b border-gray-200 dark:border-slate-800 flex items-center justify-between lg:hidden">
          <button
          ...
          <button
            ...
            className="btn-touch p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-slate-700 flex-shrink-0 touch-manipulation"
      ...
      <div className="p-3 sm:p-4 border-t border-gray-200 dark:border-slate-800">
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg transition-colors btn-touch touch-manipulation"
        >
