  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <div className="flex items-center space-x-3 mb-3">
              ...
              {question.codeImplementations && (
                <span className="text-xs px-3 py-1 rounded-full border bg-indigo-100 text-indigo-600">
        ...
        <div className="flex items-center space-x-3 mt-5 mb-4">
          ...
          {question.codeImplementations && (
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2.5 bg-indigo-100 text-indigo-700 rounded-xl hover:bg-indigo-200 transition-all duration-300 text-sm font-medium border border-indigo-200"
            >
        ...
        {/* Code Implementation */}
        {showCode && question.codeImplementations && (
          <div className="mt-6">
            <CodeViewer
              implementations={question.codeImplementations}
              algorithmSteps={question.algorithmSteps}
              commonMistakes={question.commonMistakes}
              optimizations={question.optimizations}
