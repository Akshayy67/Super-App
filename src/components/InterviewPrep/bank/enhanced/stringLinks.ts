import { PracticeLink } from "./practiceLinks";
...
export const stringQuestionLinks: Record<string, PracticeLink> = {
  ...
  "enhanced-string-3": {
    ...
    geeksforgeeks: "https://practice.geeksforgeeks.org/problems/longest-palindrome-in-a-string3411/1"
  },
  "enhanced-string-4": {
  ...
  "enhanced-string-5": {
    ...
    geeksforgeeks: "https://practice.geeksforgeeks.org/problems/print-anagrams-together/1"
  },
  "enhanced-string-6": {
