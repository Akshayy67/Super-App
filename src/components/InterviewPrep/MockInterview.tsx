...
export const MockInterview: React.FC = () => {
  ...
  const [customFocusAreas, setCustomFocusAreas] = useState<string[]>(["general"]);
  ...
  const startCamera = async () => {
    try {
      ...
      if (videoRef.current) {
        ...
        console.log('Camera started successfully, video ref:', videoRef.current);
      } else {
  ...
  const questionSets = {
    general: [
      ...
      },
      {
        ...
        category: "general",
        timeLimit: 120,
        hints: ["Give specific examples", "Relate to the role", "Show confidence"],
      },
      {
        id: "gen-4",
      ...
      },
      {
        ...
        category: "general",
        timeLimit: 120,
        hints: ["Highlight unique skills", "Show enthusiasm", "Connect to company needs"],
      },
      {
        id: "gen-7",
        ...
        category: "general",
        timeLimit: 90,
        hints: ["Do your research", "Show genuine interest", "Mention recent news"],
      },
      {
        id: "gen-8",
        ...
        category: "general",
        timeLimit: 60,
        hints: ["Ask thoughtful questions", "Show engagement", "Learn about the role"],
      },
      {
        id: "gen-9",
      ...
      },
      {
        ...
        category: "general",
        timeLimit: 120,
        hints: ["Give specific examples", "Show resilience", "Mention coping strategies"],
      },
    ],
    behavioral: [
      {
      ...
      },
      {
        ...
        category: "behavioral",
        timeLimit: 150,
        hints: ["Stay professional", "Show conflict resolution", "Focus on outcome"],
      },
      {
        id: "beh-5",
      ...
      },
      {
        ...
        category: "behavioral",
        timeLimit: 120,
        hints: ["Show empathy", "Focus on solutions", "Maintain professionalism"],
      },
      {
        id: "beh-7",
        ...
        category: "behavioral",
        timeLimit: 120,
        hints: ["Show adaptability", "Mention learning strategies", "Highlight success"],
      },
      {
        id: "beh-8",
      ...
      },
      {
        ...
        category: "behavioral",
        timeLimit: 120,
        hints: ["Show flexibility", "Explain approach", "Highlight positive outcome"],
      },
      {
        id: "beh-11",
        ...
        category: "behavioral",
        timeLimit: 150,
        hints: ["Show creativity", "Mention problem-solving", "Highlight results"],
      },
      {
        id: "beh-12",
    ...
    technical: [
      ...
      },
      {
        ...
        category: "technical",
        timeLimit: 150,
        hints: ["Show methodology", "Mention tools", "Highlight best practices"],
      },
      {
        id: "tech-4",
        ...
        category: "technical",
        timeLimit: 120,
        hints: ["Show systematic approach", "Mention tools", "Highlight problem-solving"],
      },
      {
        id: "tech-5",
        ...
        category: "technical",
        timeLimit: 180,
        hints: ["Explain the problem", "Show your approach", "Highlight the solution"],
      },
      {
        id: "tech-6",
      ...
      },
      {
        ...
        category: "technical",
        timeLimit: 120,
        hints: ["Mention specific tools", "Show workflow", "Highlight collaboration"],
      },
      {
        id: "tech-8",
      ...
      },
      {
        ...
        category: "technical",
        timeLimit: 150,
        hints: ["Show learning ability", "Mention resources", "Highlight application"],
      },
      {
        id: "tech-10",
        ...
        category: "technical",
        timeLimit: 150,
        hints: ["Show methodology", "Mention considerations", "Highlight trade-offs"],
      },
      {
        id: "tech-11",
        ...
        category: "technical",
        timeLimit: 120,
        hints: ["Mention specific platforms", "Show understanding", "Highlight experience"],
      },
      {
        id: "tech-12",
      ...
      },
      {
        ...
        category: "technical",
        timeLimit: 120,
        hints: ["Show awareness", "Mention practices", "Highlight considerations"],
      },
      {
        id: "tech-15",
        ...
        category: "technical",
        timeLimit: 120,
        hints: ["Show understanding", "Mention experience", "Highlight benefits"],
      },
    ],
    quick: [
      {
    ...
    executive: [
      ...
      },
      {
        ...
        category: "executive",
        timeLimit: 120,
        hints: ["Show methodology", "Mention tools", "Highlight decision-making"],
      },
      {
        id: "exec-8",
        question: "Tell me about a time you had to manage change in your organization.",
        category: "executive",
        timeLimit: 180,
      ...
      },
      {
        ...
        category: "executive",
        timeLimit: 120,
        hints: ["Show understanding", "Be ambitious", "Connect to company goals"],
      },
    ],
  };
  ...
  const createCustomInterview = async () => {
    ...
    customQuestions.forEach((question, index) => {
      if (question.trim()) {
        generatedQuestions.push({
          ...
          timeLimit: Math.max(60, Math.floor(customDuration * 60 / finalQuestionCount)),
    ...
    if (remainingCount > 0) {
      const aiQuestions = await generateAIQuestions(customRole, customDifficulty, customFocusAreas, remainingCount);
  ...
  const generateRoleBasedQuestions = (role: string, focusAreas: string[], count: number): InterviewQuestion[] => {
    ...
    selected.forEach((question, index) => {
      questions.push({
        ...
        timeLimit: Math.max(60, Math.floor(customDuration * 60 / customQuestionCount)),
        hints: ["Be specific", "Use examples", "Stay relevant to the role"],
      });
    });
  ...
  const generateAIQuestions = async (role: string, difficulty: string, focusAreas: string[], count: number): Promise<InterviewQuestion[]> => {
    try {
...
Return only the JSON array, no additional text.`;
      ...
      const formattedQuestions: InterviewQuestion[] = aiQuestions.map((q: any, index: number) => ({
        id: `ai-${index + 1}`,
        question: q.question,
        category: q.category || focusAreas[0],
        timeLimit: q.timeLimit || 120,
        hints: q.hints || ["Be specific", "Use examples", "Stay relevant to the role"],
      }));
...
Total Questions: ${activeSession.questions.length}`;
      ...
      await vapi.start({
        name: "Interviewer",
        firstMessage: `Hello! Thank you for taking the time to speak with me today. I'm excited to learn more about you and your experience. This is a ${activeSession?.difficulty || 'medium'} level interview for a ${activeSession?.type || 'general'} position. Let's begin!`,
        transcriber: {
          ...
          <div className="bg-white border-b border-gray-200 px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  {isCameraActive ? <VideoOff className="w-4 h-4" /> : <Camera className="w-4 h-4" />}
              ...
              <div className="h-full flex flex-col space-y-6">
                ...
                <div className="flex-1 bg-gray-900 rounded-xl flex items-center justify-center relative overflow-hidden">
                  ...
                  {!isCameraActive && (
                    <div className="text-center text-gray-400">
                      ...
                      <p className="text-sm">Click "Start Camera" to see yourself</p>
                    </div>
                  )}
                </div>
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  <div className="text-center space-y-4">
                    <h3 className="text-2xl font-bold text-gray-900">Ready to Start Your Interview?</h3>
                    <p className="text-gray-600">You're about to begin a {activeSession.type} interview with {activeSession.questions.length} questions.</p>
                    ...
                    <div className="grid grid-cols-3 gap-4 max-w-md mx-auto">
                      <div className="text-center">
                        ...
                        <p className="text-sm font-medium text-gray-900">{activeSession.duration} min</p>
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm font-medium text-gray-900">{activeSession.questions.length}</p>
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm font-medium text-gray-900">{activeSession.difficulty}</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                        <div className="text-center space-y-3">
                          <p className="text-gray-600 text-sm">Changed your mind?</p>
                          <button
                            onClick={() => {
                              setActiveSession(null);
                              setIsInterviewStarted(false);
                            ...
                            className="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-all duration-300 shadow-md hover:shadow-lg text-base font-medium border border-gray-300"
                          >
                            Cancel Interview
                          </button>
                        </div>
              ...
              {callStatus === CallStatus.ACTIVE && (
                <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-3 rounded-xl shadow-lg mb-4">
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <span className="font-semibold text-lg">Interview Session Active</span>
                    <div className="w-3 h-3 bg-white rounded-full animate-pulse"></div>
                  </div>
                </div>
              )}
                ...
                {isCameraActive ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm mb-4">
                      {cameraError || "Your video will appear here during the interview"}
                    </p>
                ...
                <div className="bg-red-50 border-2 border-red-200 rounded-xl p-6">
                  <div className="text-center space-y-4">
                    <div className="flex items-center justify-center space-x-2 text-red-700">
                      ...
                      <span className="font-semibold text-lg">Interview in Progress</span>
                    </div>
                    <p className="text-red-600 text-sm">Click the button below to end your interview session</p>
                    <button
                      onClick={() => {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
        ...
        <div className="relative z-10 flex items-start justify-between">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-purple-100 mb-6 leading-relaxed">
              Master your interview skills with AI-powered practice sessions, personalized questions, and real-time feedback
            </p>
      ...
      {browserIssues.length > 0 && (
        <div className="bg-gradient-to-r from-orange-50 to-yellow-50 border border-orange-200 rounded-2xl p-6 shadow-lg">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-orange-900 mb-2">Browser Compatibility Issues</h3>
      ...
      <div>
        ...
        <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-6 border border-blue-200 shadow-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 text-lg mb-1">Enable Camera Preview</h4>
                <p className="text-gray-600">Practice while seeing yourself on screen during the interview for better self-awareness</p>
              </div>
            </div>
            <button
            ...
            <div className="flex space-x-2">
              <button
                ...
                className={`flex-1 py-4 px-6 rounded-xl text-sm font-semibold transition-all duration-300 transform ${
                  activeTab === "templates"
                    ? "bg-white text-gray-900 shadow-lg scale-105 border-2 border-blue-200"
              ...
              <button
                ...
                className={`flex-1 py-4 px-6 rounded-xl text-sm font-semibold transition-all duration-300 transform ${
                  activeTab === "custom"
                    ? "bg-white text-gray-900 shadow-lg scale-105 border-2 border-purple-200"
                    : "text-gray-600 hover:text-gray-900 hover:bg-white/50"
                }`}
              >
                <div className="flex items-center justify-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {interviewTemplates.map((template) => (
              <button
                ...
                className="group bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-2xl transition-all duration-300 text-left transform hover:scale-105 hover:border-blue-300 relative overflow-hidden"
              >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                        template.id === 'general' ? 'bg-gradient-to-br from-blue-500 to-blue-600' :
                    ...
                    <span className={`text-xs px-3 py-1 rounded-full font-semibold ${
                      template.difficulty === 'easy' ? 'text-green-700 bg-green-100' :
                      template.difficulty === 'medium' ? 'text-yellow-700 bg-yellow-100' :
        ...
        {activeTab === "custom" && (
          <div className="bg-gradient-to-br from-white via-gray-50 to-blue-50 rounded-3xl p-8 border border-gray-200 shadow-xl">
            <div className="space-y-8">
              {/* Header */}
              <div className="text-center mb-8">
                <h3 className="text-3xl font-bold text-gray-900 mb-3">Create Your Perfect Interview</h3>
                <p className="text-gray-600 text-lg">Tailor every aspect to match your target role and preferences</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 text-lg"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    onChange={(e) => setCustomQuestionCount(Math.min(parseInt(e.target.value) || 3, 10))}
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 text-lg"
                  />
                  <p className="text-sm text-gray-500 bg-blue-50 rounded-lg px-3 py-2 border border-blue-200">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
                  Add specific technologies, frameworks, or tools you want to be asked about (e.g., React, Django, AWS, Docker)
                </p>
                
                {/* Quick Add Technology Buttons */}
                {customRole.toLowerCase().includes('engineer') && (
                  <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
                    <p className="text-sm text-blue-800 font-medium mb-3">Quick add for {customRole}:</p>
                    <div className="flex flex-wrap gap-2">
                      {['React', 'Node.js', 'Python', 'JavaScript', 'Django', 'Express', 'MongoDB', 'PostgreSQL', 'AWS', 'Docker'].map((tech) => (
                        <button
                          key={tech}
                          type="button"
                          onClick={() => {
                            if (!customTechTags.includes(tech)) {
                              setCustomTechTags([...customTechTags.filter(tag => tag.trim()), tech]);
                            }
                          }}
                ...
                {customRole.toLowerCase().includes('data') && (
                  <div className="bg-green-50 rounded-xl p-4 border border-green-200">
                    <p className="text-sm text-green-800 font-medium mb-3">Quick add for {customRole}:</p>
                    <div className="flex flex-wrap gap-2">
                      {['Python', 'R', 'SQL', 'Pandas', 'NumPy', 'Scikit-learn', 'TensorFlow', 'PyTorch', 'Tableau', 'Power BI'].map((tech) => (
                        <button
                          key={tech}
                          type="button"
                          onClick={() => {
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 bg-gray-50 rounded-xl px-4 py-3 border border-gray-200">
                  Add specific questions you want to practice. Leave blank to generate questions automatically using AI.
                </p>
                <div className="space-y-3">
              ...
              <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-6 border border-blue-200 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-blue-900 mb-2">AI-Powered Question Generation</h4>
                    <p className="text-blue-700 leading-relaxed">
                      When you don't provide custom questions, our AI will automatically generate up to {customQuestionCount} personalized interview questions based on your role, difficulty level, focus areas, and technology tags. These questions will be tailored specifically for {customRole || 'your target position'}.
                      {customTechTags.filter(tag => tag.trim()).length > 0 && (
                        <span className="block mt-3 p-3 bg-white/50 rounded-lg border border-blue-200">
                          <strong className="text-blue-800">Technology focus:</strong> {customTechTags.filter(tag => tag.trim()).join(', ')}
                        </span>
                      )}
                    </p>
                  </div>
      ...
      {/* Tips Card */}
      <div className="bg-gradient-to-r from-yellow-50 via-orange-50 to-amber-50 rounded-3xl p-8 border border-yellow-200 shadow-xl">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Pro Tips for Interview Practice</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Choose the right difficulty level for your experience</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>
      ...
      {messages.length > 0 && (
        <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-8 border border-blue-200 shadow-xl">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">Interview Feedback Analysis</h3>
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              You have interview conversation data available. Get comprehensive AI-powered feedback on your performance, 
              communication skills, technical knowledge, and areas for improvement.
            </p>
            <button
              onClick={() => setShowFeedback(true)}
          ...
          <div className="bg-white rounded-2xl p-4 border border-gray-200 shadow-2xl">
            ...
            <div className="relative">
              <video
                ...
                playsInline
                muted
                className={`w-48 h-36 object-cover rounded-lg border border-gray-300 ${isCameraActive ? 'block' : 'hidden'}`}
              />
            ...
            <div className="mt-2 text-center">
              <p className="text-xs text-gray-600">Practice your responses</p>
      ...
      {showFeedback && (
        <InterviewFeedback
          messages={messages}
          interviewType={(activeSession as InterviewSession | null)?.type || "general"}
          difficulty={(activeSession as InterviewSession | null)?.difficulty || "medium"}
          role={(activeSession as InterviewSession | null)?.type === "custom" ? customRole : ((activeSession as InterviewSession | null)?.type || "general")}
