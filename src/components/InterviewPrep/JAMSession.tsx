          ...
          <div className="max-w-xl mx-auto text-center space-y-8">
            ...
            {transcript && (
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Live Transcript</h4>
                <div className="bg-white rounded-lg p-4 border border-gray-100 max-h-32 overflow-y-auto">
